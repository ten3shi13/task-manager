namespace TaskManagerMediatR.Domain.Shared
{
    public class Result
    {
        ...
        public static Result<T> Ensure<T>(T value, Func<T, bool> predicate, Error error) => predicate(value) ? Success(value) : Failure<T>(error);
        ...
        public static Result<T> Combine<T>(params Result<T>[] results)
        {
            ...
            {
                return Failure<T>(results.SelectMany(r => r.Errors)
